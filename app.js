...
//   res
//     .status(200)
//     .json({ status: "success", message: "Retrieved a list of all todos" });
// });

// router.get("/:id", (req, res) => {
//   const dummyDB = [
//     { id: 1, name: "Walk the dog", deadline: "14.03.2025", points: 123 },
//   ]; //Just simulate a DB to create some error scenarios
...
//         .json({
//           status: "success",
//           message: "Retrieved a single todo",
//           data: todo,
//         })
...
//   res
//     .status(201)
//     .json({ status: "succes", message: "Created a new todo", data: todo });
// });
